...
public class BigIntegerMatrix {
     ...
     * @param   columns
     *          The columns of the matrix. Null values are not allowed.
     * @param   amountOfRows
     *          The amount of rows of the matrix. Should be a strictly positive value.
     */
     ...
     *          The amount of columns of the matrix. Should be a strictly positive value.
     * @param   rows
     *          The rows of the matrix. Null values are not allowed.
     */
     ...
     * @return  A not-null 2D char array of lengths columns x rows, where each subarray represents a bit representation of the columns of this matrix.
